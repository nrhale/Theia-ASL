...
class Module:
    def __init__(self, module_name, model, sign_list=[], high_score=0, high_score2=0, high_score3=0, high_score4=0):
...
def load_mod_user_data(loaded_module_dicts):
    ...
    for module_dict in loaded_module_dicts:
        ...
        new_mod = Module(module_dict['module_name'], module_dict['model'], s_list, module_dict['high_score'], module_dict['high_score2'], module_dict['high_score3'], module_dict['high_score4'])
        mods.append(new_mod)
    return mods
